...
run mkdir /output
run dnf -y --installroot /output --releasever $(cat /etc/system-release | awk '{print $3}') --setopt=install_weak_deps=false --nodocs install glibc-minimal-langpack coreutils-single
